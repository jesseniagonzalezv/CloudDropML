...
from utils.functions_modis import obtain_df_data_level1_level2, projection_level2_swath_predicted, convert_to_xarray_swath, plot_lwp_nd_modis_retrievals
# , data_level1_level2
# modis_level1_level2
...
def main():
    ...
    result_folder_swath = f"{result_folder}/swath"
